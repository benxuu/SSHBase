...
(function() {
    ...
    document.write('<script type="text/javascript" src="' + path + '/scripts/ext/ext-all-debug-w-comments' + '.js"></script>');
//    document.write('<script type="text/javascript" src="' + path + '/scripts/ext/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
    if (neptune) {
